...
const Header = ({
  ...
  useEffect(() => {
    ...
    const fetchProviders = async () => {
      try {
        const response = await fetch('https://n8n-api-maxodds.r954jc.easypanel.host/api/super-odds/providers');
  ...
  const logoSrc = theme === 'dark' ? '/images/logomaxs.png' : '/images/logomaxs.png';
